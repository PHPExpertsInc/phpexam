...
@section('content')
    <h3>Senior PHP Quiz</h3>
    <p><img class="align-left" src="/images/noob.png" width="136" height="140" />
    <p>
        This test is geared for people who want to proceed in career of PHP with 5+ years of experience.
    </p>
    <hr />
    <form method="post" action="/submission">
        {{ csrf_field() }}
        <input type="hidden" name="quiz" value="senior"/>
        <div class="col_12">
            <div>
